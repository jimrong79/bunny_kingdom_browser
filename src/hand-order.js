const categoryOrder=['territory','city','farm','camp','sky_tower','rainbow','chimney','tax_collector','provisions','parchment'];
...
export function sortedHand(cards) {
  return [...cards].sort((a,b)=>
    ...
    || Number(a.boardId==='great_cloud')-Number(b.boardId==='great_cloud')
