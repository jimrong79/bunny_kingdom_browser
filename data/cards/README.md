...
The user confirmed Opportunist's wording as 10 Golden Carrots for second place after final scoring. The user also confirmed on 2026-09-08 that Matriarch requires an outright territory lead; ties score zero. The remaining questions concern Opportunist ties/copy interactions, copy-card targets and ordering, and multiple Treasure Hunter effects. The source's Golden Carrot point rewards remain distinct from basic Carrot resource production.
